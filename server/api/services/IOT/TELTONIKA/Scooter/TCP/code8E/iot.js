...
module.exports = {
    ...
    async encodeCommand(command, imei, commandQuantity) {
        ...
        let commandSize = (commandStructure.imei.end + command.length) / 2;
        let dataSize = commandStructure.codecId.end + commandStructure.commandQuantity1.end + commandStructure.commandType.end + commandStructure.commandSize.end + commandStructure.imei.end + command.length + commandStructure.commandQuantity2.end;
        dataSize /= 2;
