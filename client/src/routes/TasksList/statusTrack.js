...
import { WORK_FLOW, FILTER_BY_WORK_FLOW } from '../../constants/Common';
    ...
    render() {
        ...
        let columns = [
            ...
            },
            {
                ...
                dataIndex: 'before',
                render: (text) => {
                    let before = text && FILTER_BY_WORK_FLOW.find((ele) => { return ele.type === text });
            ...
            },
            {
                ...
                dataIndex: 'after',
                render: (text) => {
                    let after = text && FILTER_BY_WORK_FLOW.find((ele) => { return ele.type === text });
