...
class Documents extends Component {
    ...
    render() {
        ...
        let FilterArray = [
            {
                title: <IntlMessages id="app.partner.documentType" />,
                                ...
                                <Card className="vehicleListing bankcard"
                                    ...
                                    extra={<div style={{ marginRight: '14px' }}>
                                        <ActionButtons
                                            ...
                                            deleteMsg={<IntlMessages id="app.partner.documentDeleteConfirmation" />}
                                            deleteObj={{
                                        ...
                                        <div className="scooterIC" style={{ float: 'right', marginLeft: '8px' }}>
                                            <Link to={record.path} target="_blank" download>
                                                <Icon type="download" />
                                            </Link>
                                        </div>
                                        <div className="scooterIC" style={{ float: 'right' }}>
                                            <Link to={record.path} target="_blank">
                                                <Icon type="eye" />
                                            </Link>
                                        </div>
                                    </div>}
                                >
                                    {record.name !== '' &&
                                        <div className="scooterID" style={{ justifyContent: 'flex-start' }}>
                                            <div className="lbl" style={{ marginLeft: '0px' }}>Doc Name:</div>
                                            <div className="ids" >
                                                {record.name}
                                            </div>
                                        </div>}
                                    ...
                                    <div className="scooterID" style={{ justifyContent: 'flex-start' }}>
                                        <div className="lbl" style={{ marginLeft: '0px' }}>Uploaded At:</div>
                                        <div className="ids" >
