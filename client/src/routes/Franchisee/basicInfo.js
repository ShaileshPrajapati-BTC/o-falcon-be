...
import { Card, Icon, Row, Tooltip, Spin } from "antd";
...
class BasicInfo extends Component {
    constructor(props) {
        ...
        this.state = {
            loading: false,
            summaryData: [
                { name: <IntlMessages id="app.dashboard.totalRide" />, key: 'totalRide', value: 0 },
                { name: <IntlMessages id="app.dashboard.totalRevenue" />, key: 'totalRevenue', value: 0 },
                { name: <IntlMessages id="app.dashboard.totalVehicle" />, key: 'totalVehicle', value: 0 },
                { name: <IntlMessages id="app.partner.totalCommission" />, key: 'totalCommission', value: 0 },
                { name: <IntlMessages id="app.partner.payableCommission" />, key: 'payableCommission', value: 0 }
            ],
            filter: {
                filter: {
                ...
                <Card className="CardTwoSec">
                    <div className="cardInnerHead">
                        <h3 className="dashboardCardTitle">
                            <IntlMessages id="app.partner.partnerSummary" />
                        </h3>
