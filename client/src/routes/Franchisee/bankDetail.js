...
import BankUpsertForm from './bankDetailUpsertForm';
            ...
            <>
                <div className="topbarCommonBtn" style={{ float: 'right' }}>
                    <Button type="primary" onClick={this.handelclick}>
                        ...
                        <span><IntlMessages id="app.add" /></span>
                    </Button>
                </div>
                {data &&
                            ...
                            return <Col lg={12} md={12} sm={24} xs={24} style={{ marginBottom: '8px' }}>
                                    ...
                                    extra={record.isPrimary === true ?
                                        ...
                                        <>
                                            <Tag color="red" onClick={() => this.handelPrimary(record.id)} className="gx-pointer">
                                                <IntlMessages id="app.partner.setPrimary" />
                                            </Tag>
                                            <ActionButtons
                                                edit={() => {
                                                    return this.handleEdit(record);
                                                }}
                                                deleteMsg={<IntlMessages id="app.partner.confirmationBankDetails" />}
                                                deleteObj={{
                                ...
                                >
                                    ...
                                    <div className="scooterID" style={{ justifyContent: 'flex-start' }}>
                                        <div className="lbl" style={{ marginLeft: '0px' }}><IntlMessages id="app.partner.accountHolderName" />:</div>
                                        <div className="ids" >
                                            {record.accountHolderName}
                                        </div>
                                    </div>
                                    <div className="scooterID" style={{ justifyContent: 'flex-start' }}>
                                        <div className="lbl" style={{ marginLeft: '0px' }}><IntlMessages id="app.partner.accountNumber" />:</div>
                                        <div className="ids" >
                                            {record.accountNumber}
                                        </div>
                                    </div>
                                    <div className="scooterID" style={{ justifyContent: 'flex-start' }}>
                                        <div className="lbl" style={{ marginLeft: '0px' }}><IntlMessages id="app.partner.routingNumber" />:</div>
                                        <div className="ids" >
