...
class RentalPayment extends Component {
  ...
  render() {
    ...
    const showAmount = <React.Fragment>
      <span style={{ marginRight: 10 }}>Payable : <span style={{ color: "red" }}>{UtilService.displayNumber(accountPayable)} {DEFAULT_BASE_CURRENCY}</span></span>
      <span style={{ marginRight: 10 }}>Receivable : <span style={{ color: "green" }}>{UtilService.displayNumber(accountReceivable)} {DEFAULT_BASE_CURRENCY}</span></span>
    </React.Fragment >
        ...
        <Affix offsetTop={1}>
          <div className="gx-module-box-header">
            <Row type="flex" align="middle" justify="space-between">
              <h1 className="pageHeading">Client Payments</h1>
